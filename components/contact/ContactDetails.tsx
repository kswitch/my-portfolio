...
export default function ContactDetails(): JSX.Element {
    return (
        <div className={styles.container}>
            ...
            or have some advice for me or just want to say 
            &quot;Hi 👋&quot; in any case feel free to Let me know. 
            I will do my best to respond back. 
            😊 The quickest way to reach out to me is via the contact form and I will get back to you ASAP.
        </div>
    )
}